...
const SideBarOpen = () => {
  ...
  const activeLink: string =
    "flex item-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text text-md m-2";
  ...
  return (
    <>
      <div className="dark:bg-main-dark-bg relative h-screen w-72 bg-white md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10 shadow-lg">
        <div className="flex justify-between items-center">
          ...
          >
            <MdOutlineSpaceDashboard /> <span>CRM</span>
          </Link>
        </div>
        <div className="mt-10">
          {links.map((items) => (
            <div key={items.titleOpen}>
